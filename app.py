...
vectorstore = get_vectorstore(embeddings=embedding)
retriever = ClimateXRetriever(vectorstore=vectorstore)
...
- I answer questions based on IPCC Reports 2023.
...
with gr.Blocks(title='Climate-X', theme=theme, elem_id='main_component') as demo:
    ...
    (examples_hidden
        ...
        .then(chat, [examples_hidden, chatbot], [chatbot, sources_textbox],concurrency_limit = 8,api_name = "chat_examples")
